 ...
 * then exits with status 2 (distinct from status 1, which is reserved for fmt/lint findings).
 * Anything else propagates as an unhandled exception so genuine bugs surface with their full stack trace.
 */
